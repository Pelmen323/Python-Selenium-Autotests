...
class TestUserAddToBasketFromProductPage:
    ...
    def setup(self, browser):
        ...
        email = f"{''.join([random.choice(string.ascii_letters + string.digits) for i in range(10)])}@example.com"
...
@pytest.mark.xfail(reason="Reported, not fixed yet. Bug report: https://github.com")
...
def test_guest_cant_see_product_in_basket_opened_from_product_page(browser):
    ...
    basket_page.empty_basket_message_should_include_text()
